...
public class OutputConsole extends JFrame {
    ...
    public static final int INITIAL_ROWS = 40;
    public static final int INITIAL_COL = 80;
    ...
    public OutputConsole(String title, OutputStream loggingStream) throws IOException {
        _logStream = loggingStream;
        // Set up System.out
        ...
        textArea.setRows(INITIAL_ROWS);
        textArea.setColumns(INITIAL_COL);
    ...
    public OutputConsole(String title) throws IOException {
        this(title, new NullOutputStream());
    }
