...
/**
 * The OptionLegend class defined how an option is parsed by a GetOpts object.
 * Each option passed to the GetOpts object will be represented by an
 * OptionLegend. An OptionLegend can be constructed in one of two ways:<br>
 * <br>
 * By passing in only the name of the option: OptionLegend("opt1")<br>
 * By passing in the name and description of the option: OptionLegend("opt1",
 * "the option I need to have")<br>
 * <br>
 * These methods require that the implementer use the supplied setter methods to
 * set further characteristics of the OptionLegned.
 * 
 * @see GetOpts
 * @author trey.kirk
 *
...
public class OptionLegend implements Comparable<OptionLegend> {
    ...
    /**
     * Key used to create an OptionLegend for unswitched options (those values that
     * don't require a switched option). Implementers of the GetOpts rarely need
     * this value to create OptionLegend objects as the default unswitch
     * OptionLegend is provided automatically. Use
     * {@link GetOpts#getUnswitchedOptions()} to retrieve those values.
     */
    ...
    /**
     * Constructor requiring the option's name and description. Other values are set
     * using the following default values.<br>
     * Required: false <br>
     * Multi: false <br>
     * Flag: false<br>
    ...
    /**
     * Constructor requiring only the option's name. Other values are set using the
    ...
    /**
     * Sets the hidden flag. OptionLegends that are hidden will not be shown in the
     * GetOpts usage. While not enforced, isHidden should be treated as mutually
     * exclusive with isRequired. Otherwise usage may not clearly explain to a user
     * what required option was missing. This value is set to false by default.
     * 
     * @param isHidden Boolean indicating that this option is hidden from the usage
     *                 statement.
     */
     ...
     * 
     * @return false if this OptionLegend should be reported in the usage, true if
     *         it should be hidden.
     */
    ...
    /**
     * Sets the 'is flag' flag to true or false. If an option is a flag, no value is
     * expected for the option.
     * 
     * @param flag Boolean indicating that this OptionLegend is a flag or not
     * @throws OptionLegendException
     */
    public void setFlag(boolean flag) throws OptionLegendException {
    ...
    /**
     * Sets the 'is multi' flag indicating that the option can be specified more
     * than once. If it is specified more than once, an ArrayList is creatd to store
     * the values. Use {@link GetOpts#getList(String)} to return that list.
     * 
     * @param multi Boolean indicating this option is a multi-valued option.
     * @throws OptionLegendException
     */
    public void setMulti(boolean multi) throws OptionLegendException {
     ...
     * @throws OptionLegendException
     */
    public void setRequired(boolean required) throws OptionLegendException {
    ...
    /**
     * A default value can be derived via concatonating static values plus an option
     * value. Static values are passed as is. Values dervied from another option are
     * passed in ala '$optionName'<br>
     * <br>
     * Setting this infers a default value is available and that this option is
     * hidden from the command line usage. If the user is intended to override this
     * value, one should un-hide the option. Note that hidden options like this can
     * always be overridden regardless of viewability.<br>
     * <br>
     * A derived value may be a multi-valued option, but derivision looses its
     * meaning then.
     * 
     * @param formulae
     */
    public void setDerivision(String... formula) {
        if (_log.isTraceEnabled())
            _log.trace("Setting derivation: " + Arrays.toString(formula));
        if (getDefaultValue() != null) {
    ...
    /**
     * Package-private getter to be used by {@link GetOpts}. GetOpts will expand the
     * formula values upon request by the caller.
     * 
     * @return
     */
    ...
    /**
     * Sets the isDerived flag. This flag is not intended to be set directly by the
     * user, rather by {@link OptionLegend#setDerivision(String...)}
     */
    ...
    public void setInteractive(boolean interactive) {
        ...
        if (this._interactive) this._required = true;
    }
    ...
    public String getInteractiveOption() {
        Scanner scanner = new Scanner(System.in);
        StringBuilder buff = new StringBuilder(_optName).append(": ");
        if (_optDescription != null && !"".equals(_optDescription.trim())) {
            buff.append(_optDescription);
        }
        buff.append("> ");
    ...
    public void setAllowedValues(String[] values) {
        if (_log.isTraceEnabled())
            _log.trace("Setting allowed values: " + Arrays.toString(values));
        _optValues = values;
        _isLimited = true;
    }

    /**
     * @return An Array of String indicating the allowed values this option can
     *         have.
     */
    ...
    /**
     * Returns the current example value to be displayed during Usage. If not yet
     * set, it will default to the name of the option.
     * 
     * @return
     */
    ...
    /*
     * Convinience method used to set the various behaviors of this option. The
     * array index this option was specified in is also passed to identify the type
     * of behavior being set.
     * 
     * @param item
     * 
     * @param value
     ...
     * @throws OptionLegendException
     * 
     * Seems like we've re-implemented a very basic Map... Why not just back this
     * data up with a map?
     */
    private void setLegend(int item, String value) throws OptionLegendException {
        switch (item) {
            case OPT_NAME: {
                _optName = value;
                break;
    ...
    /**
     * Provided an array of OptionLegend objects, this method searches for one of a
     * given name.
     * 
